...
// route is /admin/approve-attestation
router.post("/approve-attestation", adminController.approveAttestation);

// route is /admin/attestation-form
router.post("/attestation-form", adminController.postSendAttestation);
